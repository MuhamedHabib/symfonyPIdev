...
class ParticipationController extends AbstractController
{
     ...
     */
    public function index(ParticipationRespository $participationRespository  ,Request $request, PaginatorInterface $paginator): Response
    {
        $donnees = $this->getDoctrine()->getRepository(Participation::class)->findAll();
