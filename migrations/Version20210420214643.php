 ...
 */
final class Version20210420214643 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE file CHANGE id id VARCHAR(255) CHARACTER SET utf32 NOT NULL COLLATE `utf32_general_ci`');
    }
}
